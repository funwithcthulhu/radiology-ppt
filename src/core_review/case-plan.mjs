...
const CASE_DOMAIN_IDS = CORE_REVIEW_DOMAINS.map((domain) => domain.id).filter(
  (domain) => !NON_CASE_DOMAINS.has(domain),
);
...
const DEFAULT_CORE_REVIEW_CASES = [
  caseItem("neuro", "acute ischemic stroke", "brain", ["CT", "MRI"], {
    topicFocus: "vascular",
  }),
  caseItem(
    "neuro",
  ...
  caseItem("neuro", "subarachnoid hemorrhage", "brain", ["CT", "Angiography"], {
    topicFocus: "vascular",
  }),
  caseItem("neuro", "subdural hematoma", "brain", ["CT", "MRI"], {
    topicFocus: "trauma",
  }),
  caseItem("neuro", "epidural hematoma", "brain", ["CT"], {
    topicFocus: "trauma",
  }),
  caseItem("neuro", "glioblastoma", "brain", ["MRI", "CT"], {
    topicFocus: "tumor",
  }),
  caseItem("neuro", "meningioma", "brain", ["MRI", "CT"], {
    topicFocus: "tumor",
  }),
  caseItem(
    "neuro",
  ...
  caseItem("neuro", "pituitary macroadenoma", "sella", ["MRI", "CT"], {
    topicFocus: "tumor",
  }),
  caseItem("neuro", "multiple sclerosis", "brain and spine", ["MRI"]),
  caseItem("neuro", "cerebral venous thrombosis", "brain", ["MRI", "CT"], {
    topicFocus: "vascular",
  }),
  caseItem("neuro", "normal pressure hydrocephalus", "brain", ["CT", "MRI"]),

  caseItem("thoracic", "pneumonia", "chest", ["X-ray", "CT"], {
    topicFocus: "infection",
  }),
  ...
  caseItem("thoracic", "pulmonary embolism", "chest", ["CT"], {
    topicFocus: "vascular",
  }),
  caseItem("thoracic", "lung cancer", "chest", ["CT", "X-ray"], {
    topicFocus: "tumor",
  }),
  caseItem("thoracic", "pleural effusion", "chest", ["X-ray", "CT"]),
  caseItem("thoracic", "empyema", "chest", ["CT", "X-ray"], {
    topicFocus: "infection",
  }),
  caseItem("thoracic", "interstitial lung disease", "chest", ["CT", "X-ray"]),
  caseItem("thoracic", "sarcoidosis", "chest", ["X-ray", "CT"]),
  caseItem("thoracic", "tuberculosis", "chest", ["X-ray", "CT"], {
    topicFocus: "infection",
  }),
  caseItem("thoracic", "atelectasis", "chest", ["X-ray", "CT"]),

  caseItem("cardiovascular", "aortic dissection", "aorta", ["CT", "MRI"], {
    topicFocus: "vascular",
  }),
  caseItem("cardiovascular", "aortic aneurysm", "aorta", ["CT", "Ultrasound"], {
    topicFocus: "vascular",
  }),
  caseItem("cardiovascular", "pericardial effusion", "heart", [
    "CT",
    "X-ray",
    "Ultrasound",
  ]),
  ...
  caseItem("gi", "appendicitis", "right lower quadrant", ["CT", "Ultrasound"], {
    topicFocus: "infection",
  }),
  caseItem("gi", "diverticulitis", "colon", ["CT"], {
    topicFocus: "infection",
  }),
  ...
  caseItem(
    ...
    "acute cholecystitis",
    "gallbladder",
    ["Ultrasound", "CT", "Nuclear Medicine"],
    { topicFocus: "infection" },
  ),
  caseItem("gi", "choledocholithiasis", "bile ducts", ["Ultrasound", "MRI"]),
  caseItem("gi", "hepatocellular carcinoma", "liver", ["CT", "MRI"], {
    topicFocus: "tumor",
  }),
  caseItem("gi", "cirrhosis", "liver", ["Ultrasound", "CT", "MRI"]),
  caseItem("gi", "colonic carcinoma", "colon", ["CT", "Fluoroscopy"], {
    topicFocus: "tumor",
  }),

  caseItem("gu", "obstructing ureteric stone", "urinary tract", [
    "CT",
    "Ultrasound",
  ]),
  caseItem("gu", "pyelonephritis", "kidney", ["CT", "Ultrasound"], {
    topicFocus: "infection",
  }),
  caseItem("gu", "renal abscess", "kidney", ["CT", "Ultrasound"], {
    topicFocus: "infection",
  }),
  caseItem(
    "gu",
  ...
  caseItem("gu", "bladder carcinoma", "bladder", ["CT", "MRI", "Ultrasound"], {
    topicFocus: "tumor",
  }),
  caseItem("gu", "prostate cancer", "prostate", ["MRI", "Nuclear Medicine"], {
    topicFocus: "tumor",
  }),
  caseItem("gu", "testicular torsion", "testis", ["Ultrasound"], {
    topicFocus: "vascular",
  }),
  caseItem("gu", "ovarian torsion", "adnexa", ["Ultrasound", "CT", "MRI"], {
    topicFocus: "vascular",
  }),
  caseItem("gu", "ectopic pregnancy", "pelvis", ["Ultrasound"], {
    ageGroup: "adult",
  }),
  caseItem("gu", "endometrial carcinoma", "uterus", ["MRI", "Ultrasound"], {
    topicFocus: "tumor",
  }),
  caseItem(
    "gu",
  ...
  caseItem("msk", "osteomyelitis", "bone", ["MRI", "X-ray", "CT"], {
    topicFocus: "infection",
  }),
  caseItem("msk", "septic arthritis", "joint", ["MRI", "Ultrasound"], {
    topicFocus: "infection",
  }),
  caseItem("msk", "avascular necrosis", "hip", ["MRI", "X-ray"], {
    topicFocus: "vascular",
  }),
  caseItem("msk", "osteosarcoma", "bone", ["X-ray", "MRI"], {
    topicFocus: "tumor",
  }),
  caseItem("msk", "Ewing sarcoma", "bone", ["X-ray", "MRI"], {
    topicFocus: "tumor",
  }),
  caseItem("msk", "giant cell tumor", "bone", ["X-ray", "MRI"], {
    topicFocus: "tumor",
  }),
  caseItem(
    "msk",
  ...
  caseItem("msk", "scaphoid fracture", "wrist", ["X-ray", "CT"], {
    topicFocus: "trauma",
  }),
  caseItem("msk", "slipped capital femoral epiphysis", "hip", ["X-ray"], {
    ageGroup: "pediatric",
  }),
  ...
  caseItem("pediatric", "pyloric stenosis", "stomach", ["Ultrasound"], {
    ageGroup: "pediatric",
  }),
  caseItem("pediatric", "necrotizing enterocolitis", "abdomen", ["X-ray"], {
    ageGroup: "neonatal",
  }),
  caseItem(
    "pediatric",
  ...
  caseItem("pediatric", "Wilms tumor", "kidney", ["Ultrasound", "CT", "MRI"], {
    ageGroup: "pediatric",
    topicFocus: "tumor",
  }),
  caseItem(
    ...
    { ageGroup: "pediatric", topicFocus: "tumor" },
  ),
  caseItem("pediatric", "medulloblastoma", "posterior fossa", ["MRI"], {
    ageGroup: "pediatric",
    topicFocus: "tumor",
  }),
  caseItem("pediatric", "retinoblastoma", "orbit", ["MRI", "Ultrasound"], {
    ageGroup: "pediatric",
    topicFocus: "tumor",
  }),
  caseItem(
    ...
    "chest and abdomen",
    ["X-ray", "CT"],
    { ageGroup: "neonatal", topicFocus: "congenital" },
  ),
  caseItem("pediatric", "meconium ileus", "abdomen", ["X-ray", "Fluoroscopy"], {
    ageGroup: "neonatal",
  }),
  caseItem(
    "pediatric",
  ...
  caseItem("breast", "simple breast cyst", "breast", [
    "Ultrasound",
    "Mammography",
  ]),
  ...
  caseItem("nuclear", "parathyroid adenoma", "neck", [
    "Nuclear Medicine",
    "Ultrasound",
  ]),
  caseItem(
  ...
  caseItem("nuclear", "renal obstruction", "urinary tract", [
    "Nuclear Medicine",
    "Ultrasound",
  ]),
  caseItem(
  ...
  caseItem("ultrasound", "thyroid nodule", "thyroid", ["Ultrasound"], {
    topicFocus: "tumor",
  }),
  caseItem("ultrasound", "gallstones", "gallbladder", ["Ultrasound"]),
  caseItem("ultrasound", "ectopic pregnancy", "pelvis", ["Ultrasound"]),
  caseItem("ultrasound", "ovarian torsion", "adnexa", ["Ultrasound"], {
    topicFocus: "vascular",
  }),
  caseItem("ultrasound", "testicular torsion", "testis", ["Ultrasound"], {
    topicFocus: "vascular",
  }),
  ...
  caseItem(
    ...
    ["Ultrasound"],
    { ageGroup: "pediatric", topicFocus: "infection" },
  ),

  caseItem("radiography_fluoroscopy", "achalasia", "esophagus", [
    "Fluoroscopy",
  ]),
  caseItem(
    "radiography_fluoroscopy",
  ...
  caseItem("radiography_fluoroscopy", "small bowel obstruction", "abdomen", [
    "X-ray",
    "Fluoroscopy",
  ]),
  caseItem("radiography_fluoroscopy", "aspiration", "swallowing study", [
    "Fluoroscopy",
  ]),
  caseItem(
    "radiography_fluoroscopy",
  ...
  caseItem("ir", "uterine fibroids", "uterus", [
    "MRI",
    "Ultrasound",
    "Angiography",
  ]),
  ...
  caseItem("ct", "adrenal hemorrhage", "adrenal gland", ["CT", "MRI"], {
    topicFocus: "trauma",
  }),
  caseItem("ct", "bowel perforation", "abdomen", ["CT", "X-ray"]),
  caseItem("ct", "splenic laceration", "spleen", ["CT"], {
    topicFocus: "trauma",
  }),
  caseItem("ct", "renal trauma", "kidney", ["CT"], { topicFocus: "trauma" }),
  caseItem("ct", "pulmonary embolism", "pulmonary arteries", ["CT"], {
    topicFocus: "vascular",
  }),

  caseItem("mr", "cholangiocarcinoma", "bile ducts", ["MRI", "CT"], {
    topicFocus: "tumor",
  }),
  caseItem("mr", "perianal fistula", "pelvis", ["MRI"]),
  caseItem("mr", "prostate cancer", "prostate", ["MRI"], {
    topicFocus: "tumor",
  }),
  caseItem("mr", "uterine fibroid degeneration", "uterus", [
    "MRI",
    "Ultrasound",
  ]),
  caseItem("mr", "stress fracture", "bone", ["MRI", "X-ray"], {
    topicFocus: "trauma",
  }),
  caseItem("mr", "spinal epidural abscess", "spine", ["MRI"], {
    topicFocus: "infection",
  }),
];
...
export function normalizeCoreReviewCaseDomain(value) {
  ...
  if (
    !text ||
    ["general", "mixed", "all", "core", "core review"].includes(text)
  ) {
    return "";
  }
...
function normalizeCaseMix(value) {
  ...
  if (
    ["focused", "focus", "domain", "single-domain", "single_domain"].includes(
      text,
    )
  ) {
    return "focused";
...
function normalizeModalityMix(value) {
  const text = collapseWhitespace(value).toLowerCase();
  if (
    ["classic", "classic-modality", "classic_modality", "primary"].includes(
      text,
    )
  ) {
    return "classic";
...
function normalizeCaseBankItem(item, index, sourceId) {
  ...
  const domain = normalizeCoreReviewCaseDomain(
    item.domain || item.coreReviewDomain || item.section || "",
  );
  const diagnosis = collapseWhitespace(
    item.diagnosis || item.name || item.query || item.title || "",
  );
  if (!domain || !diagnosis) {
    return null;
  }
  ...
  const systems = dedupe(
    stringArray(
      item.systems ||
        item.searchSystems ||
        DEFAULT_SYSTEMS_BY_DOMAIN[domain] ||
        [],
    )
      .map((value) => collapseWhitespace(value))
      .filter(Boolean),
  ...
  const id = collapseWhitespace(
    item.id || `${sourceId}-${domain}-${slugify(diagnosis)}-${index + 1}`,
  );
  ...
  return {
    ...
    domain,
    diagnosis,
    searchQuery: collapseWhitespace(
      item.searchQuery || item.query || diagnosis,
    ),
...
export async function loadCoreReviewCaseBank(caseBankPath = "") {
  ...
  if (!resolvedPath) {
    return {
      ...
      path: "",
      cases: normalizeCaseBank(
        DEFAULT_CORE_REVIEW_CASES,
        "bundled-core-case-bank",
      ),
  ...
  if (!Array.isArray(rawCases)) {
    throw new Error(
      "Core Review case bank JSON must be an array or contain a cases array.",
    );
  }
...
function buildDomainSequence(buckets, count, caseMix, focusDomain, rng) {
  ...
  const usableCaseMix =
    focusDomain && caseMix === "focused" ? "focused" : caseMix;
  ...
  for (const domain of domains) {
    const repeats =
      usableCaseMix === "even"
        ? 1
        : Math.max(1, Math.round((DOMAIN_WEIGHTS[domain] || 0.5) * 10));
...
function requestFromCase(item, planIndex, options) {
  ...
  const rawInput = collapseWhitespace(
    [item.searchQuery, studyHint].filter(Boolean).join(", "),
  );
  return {
...
function buildSummary(
  ...
  const labelByDomain = new Map(
    CORE_REVIEW_DOMAINS.map((item) => [item.id, item.label]),
  );
  const domainLabel = domain
    ? labelByDomain.get(domain) || domain
    : "mixed CORE domains";
  const countText =
  ...
  const standaloneCount =
    Number(standaloneQuestionCounts.nis || 0) +
    Number(standaloneQuestionCounts.physics || 0);
  const totalText =
...
export async function buildCoreReviewCasePlan(args = {}) {
  ...
  const domain = normalizeCoreReviewCaseDomain(
    args.domain || args.coreReviewDomain || "",
  );
  ...
  const seed = collapseWhitespace(
    args.seed || `${domain || "mixed"}|${caseMix}|${modalityMix}|${caseCount}`,
  );
  const rng = createSeededRandom(seed);
  const caseBank = await loadCoreReviewCaseBank(args.caseBankPath || "");
  const cases = caseBank.cases.filter(
    (item) => !domain || caseMix !== "focused" || item.domain === domain,
  );
  if (!cases.length) {
    throw new Error(
      "No CORE review case-bank entries matched the requested settings.",
    );
  }

  const buckets = groupByDomain(cases, rng);
  const domainSequence = buildDomainSequence(
    buckets,
    candidateCaseCount,
    caseMix,
    domain,
  ...
  const options = {
    ...
    standaloneQuestionCounts: args.standaloneQuestionCounts || {
      nis: 0,
      physics: 0,
    },
  ...
  const entries = selected.map((item, index) =>
    requestFromCase(item, index, options),
  );
