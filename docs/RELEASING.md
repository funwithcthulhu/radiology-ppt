...
.\build-windows-installer.ps1 -Version 0.3.0
```

Output:

```text
dist\installer\Radiopaedia-Case-PowerPoint-Builder-Setup-v0.3.0.exe
```
...
gh release create v0.3.0 `
  .\dist\installer\Radiopaedia-Case-PowerPoint-Builder-Setup-v0.3.0.exe `
  --title "Radiopaedia Case PowerPoint Builder v0.3.0" `
